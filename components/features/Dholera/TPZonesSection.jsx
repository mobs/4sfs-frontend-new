    ...
    <section className="relative py-12 bg-gradient-to-b from-bgGray to-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <Button variant="primary" className="rounded-full px-8 py-4 font-semibold shadow-lg">
              Check TP Zones Map & Guidance
            </Button>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <Card variant="elevated" className="bg-gradient-to-br from-secondary to-primary text-white overflow-hidden">
            <div className="aspect-video flex flex-col items-center justify-center p-8 text-center">
              ...
              <Button variant="white" className="rounded-full px-8 py-4 font-semibold shadow-lg">
                <span className="flex items-center">
                  <FaDownload className="mr-2" />
                  Download TP Zone Map (Free)
                </span>
              </Button>
            </div>
          </Card>
